...
platform clipboard roles, projects a basename-only document title, persists schema 2 route-local
...
duplicate close suppression, one-shot resolution, schema 2 full-layout persistence, schema 1
migration, duplicate placement rejection before live mutation, real-host
