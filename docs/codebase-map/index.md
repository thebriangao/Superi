...
- Command discovery remains a bounded projection over existing typed owners. Catalog actions may
  ...
  retain current reasons, and palette query or modal state must not enter durable workspace state.
