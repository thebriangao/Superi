...
ownership or semantics. Render-export carries the same complete metadata through decoded, graph,
scene, delivery, and encoder provenance and rejects nonterminal or discontinuous pipeline history;
