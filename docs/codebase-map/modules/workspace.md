...
source_hash: 79dadf102a3f12bef96ea460bfe9836dda710a7b3c294e3a7d6421390c7110a0
source_files: 80
...
- `open/test-fixtures/README.md`: Defines the immutable versioned fixture layout, strict schema 1
  ...
  video, synchronized multichannel audio, timing, color and image-sequence, and media-error
  baselines plus the encoded canonical slice source.
...
The mapping inventory contains 70 UTF-8 text artifacts and ten binary payloads. Binary media is
...
cataloged aligned partial packet plus corruption evidence. The UTF-8 fixture remains the validator's smallest
...
- `open/test-fixtures/README.md` defines
  ...
  <OUTPUT_DIRECTORY>`. The UTF-8 fixture's
...
- Fresh fixture validation reports seven valid fixture versions and sixteen payloads. The video fixture
  ...
  fixture contains eight images, three sequence frames, and 448 raw sample bytes. All five generated
...
The synchronized remote revision before this checkpoint ends at
`b06751610ca9e4ca2d4030c79cf43f1f6c3a533f`.
...
`b06751610ca9e4ca2d4030c79cf43f1f6c3a533f` when the map was refreshed. Its hash describes the exact
80 discovered source files, including ten generated binary payloads, layered on that revision.
