...
source_hash: 8ffaf27b0fb601c0c4b25e5471b4d1b008e9b2a54368726331b53da8c5c03d7f
source_files: 73
...
`.worktreeinclude`, so the mapping script does not include it in this module's 73-file inventory or
...
- `open/test-fixtures/README.md`: Defines the immutable versioned fixture layout, strict schema 1
  ...
  video, synchronized multichannel audio, timing, color and image-sequence baselines, and the
  encoded canonical slice source.
...
The mapping inventory contains 67 UTF-8 text artifacts and six binary payloads. Binary media is
...
- Fresh fixture validation reports six valid fixture versions and eleven payloads. The video fixture
  ...
  fixture contains eight images, three sequence frames, and 448 raw sample bytes. All four generated
  baselines are protected by generator, CLI, real-consumer, and canonical-root contracts.
...
`a67f3f32773ad895b3e783c60d114f71d27e8294` when the map was refreshed. Its hash describes the exact
73 discovered source files, including six generated binary payloads, layered on that revision.
