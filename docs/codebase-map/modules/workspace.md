...
- `open/test-fixtures/README.md`: Defines the immutable versioned fixture layout, strict schema 1
  ...
  contributor workflow, offline validation command, and hard-failure conditions.
...
end-to-end workflows consume the data. The current UTF-8 fixture exercises that validator contract
without network access or a binary payload.
