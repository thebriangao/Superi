...
//! cubic paths, complete controls, strict persistence, and soft-coverage composition. The built-in
//! catalog and bounded CPU reference cover common visual operations, while mask rasterization,
//! transitions, text, tracking, OFX hosting, and production GPU integration remain staged in their
//! owning modules.
