...
//! exact global, project, device, and GPU accounting, and deterministic priority-aware LRU eviction
//! are implemented; persistence, proxies, render caching, and prefetch remain.
