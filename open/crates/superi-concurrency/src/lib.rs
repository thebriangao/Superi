...
//! correction, drop, and rebase decisions. Backpressure, shared-state conventions, and coordinated
//! shutdown advance through their focused checkpoints. See section 5.7 in `docs/architecture.md`.
