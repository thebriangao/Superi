...
pub use source_monitor::{
    ...
    SourceMonitorMarkUpdate, SourceMonitorMarks, SourceMonitorSeekRequest, SourceMonitorSnapshot,
    SourceMonitorStream, SourceMonitorTime, SourceMonitorUnloadRequest, SourceMonitorUpdateResult,
};
        ...
        for region in &mut selection.tracked_regions {
            ...
            for observation in &region.observations {
                ...
                if observation.frame < selection.start_frame
                    ...
                    || right.map_or(true, |value| value > NORMALIZED_REGION_SCALE)
                    || bottom.map_or(true, |value| value > NORMALIZED_REGION_SCALE)
                {
...
/// Presentation-neutral concrete project lifecycle state.
#[derive(Clone)]
