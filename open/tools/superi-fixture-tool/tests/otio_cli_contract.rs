...
impl TemporaryOutput {
    fn new() -> Self {
        ...
        let path =
            std::env::temp_dir().join(format!("superi-otio-cli-{}-{suffix}", std::process::id()));
...
#[test]
fn generate_otio_command_reports_success_and_refuses_overwrite() {
