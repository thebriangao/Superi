...
impl TemporaryOutput {
    fn new() -> Self {
        ...
        let path =
            std::env::temp_dir().join(format!("superi-timing-cli-{}-{suffix}", std::process::id()));
...
#[test]
fn generate_timing_command_reports_success_and_refuses_overwrite() {
    ...
    assert_eq!(
        ...
        "generated 5 timing cases and 18 samples\n"
    );
