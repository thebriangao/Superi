...
//! existing GPU, audio, filesystem, webview, monitor, and engine codec owners.
...
const fn implementation_for(
    ...
    match (platform, domain) {
        ...
        (DesktopPlatform::Macos, PlatformAdapterDomain::Font) => "webview-coretext",
        (DesktopPlatform::Macos, PlatformAdapterDomain::Monitor) => "tauri-cocoa-monitor",
        ...
        (DesktopPlatform::Windows, PlatformAdapterDomain::Font) => "webview-directwrite",
        (DesktopPlatform::Windows, PlatformAdapterDomain::Monitor) => "tauri-win32-monitor",
        ...
        (DesktopPlatform::Linux, PlatformAdapterDomain::Font) => "webview-fontconfig",
        (DesktopPlatform::Linux, PlatformAdapterDomain::Monitor) => "tauri-x11-wayland-monitor",
...
#[tauri::command]
pub fn desktop_platform_adapters() -> DesktopPlatformAdapterSnapshot {
...
mod tests {
    ...
    fn command_selects_the_compile_target_without_runtime_guessing() {
        let snapshot = desktop_platform_adapters();
